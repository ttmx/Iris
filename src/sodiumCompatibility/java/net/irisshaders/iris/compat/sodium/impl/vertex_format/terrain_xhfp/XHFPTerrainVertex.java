...
public class XHFPTerrainVertex implements ChunkVertexEncoder, ContextAwareVertexWriter {
	...
	public long write(long ptr,
		...
		MemoryUtil.memPutInt(ptr + 36, ExtendedDataHelper.computeMidBlock(vertex.x, vertex.y, vertex.z, contextHolder.localPosX, contextHolder.localPosY, contextHolder.localPosZ));
