	...
	public static void addBiomeUniforms(UniformHolder uniforms) {
		...
		uniforms
				.uniform1i(PER_TICK, "biome", playerI(player ->
					biomeMap.getInt(player.clientLevel.getBiome(player.blockPosition()).unwrapKey().orElse(null))))
				.uniform1i(PER_TICK, "biome_category", playerI(player -> {
					Holder<Biome> holder = player.clientLevel.getBiome(player.blockPosition());
				...
				.uniform1i(PER_TICK, "biome_precipitation", playerI(player -> {
					Biome.Precipitation precipitation = player.clientLevel.getBiome(player.blockPosition()).value().getPrecipitationAt(player.blockPosition());
				...
				.uniform1f(PER_TICK, "rainfall", playerF(player ->
					((ExtendedBiome) (Object) player.clientLevel.getBiome(player.blockPosition()).value()).getDownfall()))
				.uniform1f(PER_TICK, "temperature", playerF(player ->
						player.clientLevel.getBiome(player.blockPosition()).value().getBaseTemperature()))
