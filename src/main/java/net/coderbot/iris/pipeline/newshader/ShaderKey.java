...
public enum ShaderKey {
	...
	TEXT_INTENSITY         (ProgramId.Entities,    AlphaTests.ONE_TENTH_ALPHA,  IrisVertexFormats.TERRAIN                       , FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
	TEXT_BE                (ProgramId.Block,       AlphaTests.ONE_TENTH_ALPHA,  IrisVertexFormats.TERRAIN                       , FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
	TEXT_INTENSITY_BE      (ProgramId.Block,       AlphaTests.ONE_TENTH_ALPHA,  IrisVertexFormats.TERRAIN                       , FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
