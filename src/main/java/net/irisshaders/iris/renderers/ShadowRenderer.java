...
public class ShadowRenderer {
	...
	private String getBlockEntitiesDebugString() {
		return shouldRenderBlockEntities ? String.valueOf(renderedShadowBlockEntities) : "disabled by pack"; // TODO: + "/" + MinecraftClient.getInstance().world.blockEntities.size();
	}
